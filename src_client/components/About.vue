<template>
      <v-container class="about-doom-squad">
        ...
        <p class="mb40">Our games incorporate pyrotechnics, realistic props, special airsoft weapons, and computerized point tracking systems. We love this action pursuit sport and we are always looking to have more people come and play!</p>
        ...
        <p>Controlpointer solves the problem of players not knowing where to respawn. Created by airsoft field admins for airsoft field admins, Controlpointer is server software which renders a <span class="cRed">LIVE</span> game map that represents the active state of the game.</p>
